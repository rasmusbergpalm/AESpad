 ...
 */
	Configure::write('Security.salt', '#¤%&/()"#¤%&/947354274967656()"#¤%&/()SDFGHJKERTYUI^ØØ*^^Ø*ØØØxcvbnmertyusdfghj345678KJHGFDS');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '464026152759687585070582524343657869006783635');
